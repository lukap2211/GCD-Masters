        ...
        <ul class="nav pull-right">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="users" href="user.php?id=<?= $_SESSION['id'] ?>&amp;action=view"><i class="icon-fixed-width icon-group"></i> Users</a></li>
              <li><a class="settings" href="site.php"><i class="icon-fixed-width icon-cogs"></i> Site</a></li>
              <?php } ?>
              <li class="divider"></li>
